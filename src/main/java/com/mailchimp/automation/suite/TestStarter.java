...
public class TestStarter {
	...
	public void start() {
		...
		try	{
			...
			testng.setOutputDirectory(AppConstant.TESTNG_REPORT_DIR + PropertySettings.getInstance().getBrowser()+"TestReport/"+PropertySettings.getInstance().getYear()+"/"+PropertySettings.getInstance().getMonth()+"/"+PropertySettings.getInstance().getReportTime()); //yyyy-MM-dd-hh-mm-ss
